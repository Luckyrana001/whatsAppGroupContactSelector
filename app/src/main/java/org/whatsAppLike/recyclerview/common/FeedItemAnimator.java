package org.whatsAppLike.recyclerview.common;
...
public class FeedItemAnimator extends DefaultItemAnimator {
    ...
    public boolean animateAdd(RecyclerView.ViewHolder viewHolder) {
       /* if (viewHolder.getItemViewType() == SelectGroupContactsAdaper.VIEW_TYPE_DEFAULT) {
            if (viewHolder.getLayoutPosition() > lastAddAnimatedItem) {
                lastAddAnimatedItem++;*/
                runEnterAnimation((SelectGroupContactsAdaper.ExampleViewHolder) viewHolder);
               /* return false;
            }
        }*/
    ...
    private void runEnterAnimation(final SelectGroupContactsAdaper.ExampleViewHolder holder) {
    ...
    public boolean animateChange(@NonNull RecyclerView.ViewHolder oldHolder,
       ...
       /* if (preInfo instanceof FeedItemHolderInfo) {
            ...
            SelectGroupContactsAdaper.ExampleViewHolder holder = (SelectGroupContactsAdaper.ExampleViewHolder) newHolder;

            animateHeartButton(holder);
            updateLikesCounter(holder, holder.getFeedItem().likesCount);
            if (SelectGroupContactsAdaper.ACTION_LIKE_IMAGE_CLICKED.equals(feedItemHolderInfo.updateAction)) {
    ...
    private void animateHeartButton(final SelectGroupContactsAdaper.ExampleViewHolder holder) {
    ...
    private void updateLikesCounter(SelectGroupContactsAdaper.ExampleViewHolder holder, int toValue) {
    ...
    private void animatePhotoLike(final SelectGroupContactsAdaper.ExampleViewHolder holder) {
    ...
    private void dispatchChangeFinishedIfAllAnimationsEnded(SelectGroupContactsAdaper.ExampleViewHolder holder) {
    ...
    private void resetLikeAnimationState(SelectGroupContactsAdaper.ExampleViewHolder holder) {
